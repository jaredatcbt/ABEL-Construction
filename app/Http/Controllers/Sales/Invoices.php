...
use App\Exports\Sales\Invoice as ExportInvoice;
...
class Invoices extends Controller
{
    ...
    /**
     * Export the specified Invoice.
     *
     * @return Response
     */
    public function exportInvoice(Document $invoice)
    {
        $invoice->category_name = $invoice->category->name;
        return $this->exportExcel(new ExportInvoice($invoice), trans_choice('general.invoices', 2));
    }
