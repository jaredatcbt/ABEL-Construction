...
use App\Exports\Purchases\Bill as ExportBill;
...
class Bills extends Controller
{
    ...
    /**
     * Export the specified Bill.
     *
     * @return Response
     */
    public function exportBill(Document $bill)
    {
        $bill->category_name = $bill->category->name;
        return $this->exportExcel(new ExportBill($bill), trans_choice('general.bills', 2));
    }
