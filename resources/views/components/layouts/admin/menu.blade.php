...
<div class="container flex items-center py-3 mb-4 border-b-2 xl:hidden">
    ...
    <div class="flex items-center m-auto">
        <img src="{{ asset('public/img/abel_construction_favicon.png') }}" class="w-8 m-auto" alt="Cherry Byte" />
...
>
    <div class="w-14 py-7 px-1 bg-lilac-900 z-10 menu-scroll overflow-y-auto overflow-x-hidden theme-main-sidebar">
        <div
    ...
    <nav class="menu-list js-main-menu theme-secondory-sidebar" id="sidenav-main">
        <div class="relative mb-5 cursor-pointer">
            <button type="button" class="flex items-center" data-dropdown-toggle="dropdown-menu-company">
                <div class="w-8 h-8 flex items-center justify-center">
                    <img src="{{ asset('public/img/abel_construction_favicon.png') }}" class="h-7" alt="Cherry Byte" />
                </div>

                <div class="flex ltr:ml-2 rtl:mr-2">
                    <span class="w-28 ltr:text-left rtl:text-right block text-base">
                        <x-button.hover>
    ...
    <div class="profile-menu user-menu menu-list fixed h-full ltr:-left-80 rtl:-right-80 theme-secondory-sidebar">
    ...
    @can('read-notifications')
    <div class="notifications-menu user-menu menu-list fixed h-full ltr:-left-80 rtl:-right-80 theme-secondory-sidebar">
    ...
    <div class="settings-menu user-menu menu-list fixed h-full overflow-y-unset ltr:-left-80 rtl:-right-80 theme-secondory-sidebar">
        <div class="flex items-center mb-3">
    ...
    <div class="add-new-menu user-menu menu-list fixed h-full ltr:-left-80 rtl:-right-80 theme-secondory-sidebar">
        <div class="flex items-center mb-3">
