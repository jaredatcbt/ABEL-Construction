<div
  ...
  style="z-index: 60;"
>
  {{-- <img src="{{ asset('public/img/akaunting-loading.gif') }}" class="w-28 h-28 lg:-mt-16" alt="Cherry Byte" /> --}}
  <img src="{{ asset('public/img/abel_construction_favicon.png') }}" class="w-28 lg:-mt-16" alt="Cherry Byte" />
</div>
