<x-layouts.admin>
    ...
    <x-slot name="content">
        ...
        <x-form.section.head title="{{ trans('fuel_stock.nav_title') }}" description="{{ trans('fuel_stock.nav_description') }}" />

        <x-table>
            <x-table.thead>
                <x-table.tr class="flex items-center px-1">
                    <x-table.th class="w-2/12 sm:w-2/12">
                        {{ trans('fuel_stock.quantity') }}
                    </x-table.th>

                    <x-table.th class="w-4/12 sm:w-5/12">
                        {{ trans('fuel_stock.type') }}
                    </x-table.th>

                    <x-table.th class="w-3/12 sm:w-3/12">
                        {{ trans('fuel_stock.date') }}
                    </x-table.th>

                    <x-table.th class="w-3/12 sm:w-2/12">
                        {{ trans('fuel_stock.actions') }}
                    </x-table.th>
                </x-table.tr>
            </x-table.thead>
                            ...
                            <div class="ltr:right-8 rtl:left-8 flex items-center">
                                @can('update-offline-payments-settings')
                                    <x-button
                                        ...
                                        override="class"
                                        @click="{{ route('fuel_vehicle.edit', $item->id) }}">
