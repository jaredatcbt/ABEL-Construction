...
return [
    ...
    'invitation' => [
        'message_1'         => 'Estás recibiendo este correo electrónico porque estás invitado a unirte a Cherry Byte.',
    ...
    'information' => [
        ...
        'customize'         => 'Personaliza tu Cherry Byte',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Administrador',
            'description'   => 'Obtendrán acceso total a Cherry Byte incluyendo clientes, facturas, informes, ajustes y aplicaciones.',
        ],
        'manager' => [
            'name'          => 'Gerente',
            'description'   => 'Obtendrán acceso total a tu Cherry Byte, pero no pueden administrar usuarios y aplicaciones.',
        ],
        'customer' => [
            'name'          => 'Cliente',
