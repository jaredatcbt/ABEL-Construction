...
return [
    ...
    'invitation' => [
        'message_1'         => 'Ја добивате оваа е-пошта затоа што сте поканети да се придружите на Cherry Byte.',
    ...
    'information' => [
        ...
        'customize'         => 'Прилагодете го вашиот Cherry Byte',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Админ',
            'description'   => 'Тие добиваат целосен пристап до вашиот Cherry Byte вклучувајќи клиенти, фактури, извештаи, поставки и апликации.',
        ],
        'manager' => [
            'name'          => 'Менаџер',
            'description'   => 'Тие добиваат целосен пристап до вашиот Cherry Byte, но не можат да управуваат со корисници и апликации.',
        ],
        'customer' => [
            'name'          => 'Клиент',
