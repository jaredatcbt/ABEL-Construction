...
return [
    ...
    'invitation' => [
        'message_1'         => 'Du får detta e-postmeddelande eftersom du är inbjuden att gå med i Cherry Byte.',
    ...
    'information' => [
        ...
        'customize'         => 'Anpassa Cherry Byte',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Administratör',
            'description'   => 'De får full tillgång till din Cherry Byte inklusive kunder, fakturor, rapporter, inställningar och appar.',
        ],
        'manager' => [
            'name'          => 'Föreståndare',
            'description'   => 'De får full tillgång till din Cherry Byte, men kan inte hantera användare och appar.',
        ],
        'customer' => [
            'name'          => 'Kund',
