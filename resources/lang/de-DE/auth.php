...
return [
    ...
    'invitation' => [
        'message_1'         => 'Sie erhalten diese E-Mail, weil Sie zur zusammenarbeit bei Cherry Byte eingeladen wurden.',
    ...
    'information' => [
        ...
        'customize'         => 'Passen Sie Ihr Cherry Byte an',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Admin',
            'description'   => 'Sie erhalten vollen Zugriff auf Cherry Byte, einschließlich Kunden, Rechnungen, Berichte, Einstellungen und Apps.',
        ],
        'manager' => [
            'name'          => 'Manager',
            'description'   => 'Sie erhalten vollen Zugriff auf Cherry Byte, können aber keine Benutzer und Apps verwalten.',
        ],
        'customer' => [
            'name'          => 'Kunde',
