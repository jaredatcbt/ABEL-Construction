...
return [
    ...
    'invitation' => [
        'message_1'         => 'You are receiving this email because you are invited to join the Abel Construction.',
    ...
    'information' => [
        ...
        'customize'         => 'Customize your Abel Construction',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Admin',
            'description'   => 'They get full access to your Abel Construction including customers, invoices, reports, settings, and apps.',
        ],
        'manager' => [
            'name'          => 'Manager',
            'description'   => 'They get full access to your Abel Construction, but can\'t manage users and apps.',
        ],
        'customer' => [
            'name'          => 'Customer',
