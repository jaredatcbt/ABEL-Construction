...
return [
    ...
    'invitation' => [
        'message_1'         => 'You are receiving this email because you are invited to join the Cherry Byte.',
    ...
    'information' => [
        ...
        'customize'         => 'Customise your Cherry Byte',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Admin',
            'description'   => 'They get full access to your Cherry Byte including customers, invoices, reports, settings, and apps.',
        ],
        'manager' => [
            'name'          => 'Manager',
            'description'   => 'They get full access to your Cherry Byte, but can\'t manage users and apps.',
        ],
        'customer' => [
            'name'          => 'Customer',
