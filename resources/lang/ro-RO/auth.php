...
return [
    ...
    'invitation' => [
        'message_1'         => 'Primești acest email deoarece ești invitat să te alături în Cherry Byte.',
    ...
    'information' => [
        ...
        'customize'         => 'Personalizează-ți Cherry Byte',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Administrator',
            'description'   => 'Aceștia au acces deplin la Cherry Byte-ul tău, inclusiv la clienți, facturi, rapoarte, setări și aplicații.',
        ],
        'manager' => [
            'name'          => 'Manager',
            'description'   => 'Obțin acces deplin la Cherry Byte tău, dar nu pot gestiona utilizatorii și aplicațiile.',
        ],
        'customer' => [
            'name'          => 'Client',
