...
return [
    ...
    'invitation' => [
        'message_1'         => 'Primili ste ovaj email jer ste pozvani da se pridružite Cherry Byteu.',
    ...
    'information' => [
        ...
        'customize'         => 'Prilagodite svoj Cherry Byte',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Admin',
            'description'   => 'Oni dobijaju potpuni pristup vašem Cherry Byte-u uključujući klijente, fakture, izvještaje, postavke i aplikacije.',
        ],
        'manager' => [
            'name'          => 'Upravljaj',
            'description'   => 'Oni imaju potpuni pristup vašem Cherry Byteu, ali ne mogu upravljati korisnicima i aplikacijama.',
        ],
        'customer' => [
            'name'          => 'Kupci',
