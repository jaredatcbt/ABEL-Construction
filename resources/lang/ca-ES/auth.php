...
return [
    ...
    'invitation' => [
        'message_1'         => 'Estàs rebent aquest correu electrònic perquè estàs convidat a unir-te a l\'Cherry Byte.',
    ...
    'information' => [
        ...
        'customize'         => 'Personalitza el teu Cherry Byte',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Administrador',
            'description'   => 'Tenen accés complet al vostre Cherry Byte, inclosos clients, factures, informes, configuracions i aplicacions.',
        ],
        'manager' => [
            'name'          => 'Gerent',
            'description'   => 'Tenen accés complet al teu Cherry Byte, però no poden gestionar usuaris i aplicacions.',
        ],
        'customer' => [
            'name'          => 'Client',
