...
return [
    ...
    'invitation' => [
        'message_1'         => 'Você está recebendo este e-mail porque foi convidado a juntar-se ao Cherry Byte.',
    ...
    'information' => [
        ...
        'customize'         => 'Personalize seu Cherry Byte',
    ],
    ...
    'roles' => [
        ...
        'manager' => [
            'name'          => 'Gerente',
            'description'   => 'Eles têm acesso total ao seu Cherry Byte, mas não podem gerenciar usuários e apps.',
        ],
        'customer' => [
            'name'          => 'Cliente',
