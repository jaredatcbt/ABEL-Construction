...
return [
    ...
    'invitation' => [
        'message_1'         => 'Jūs saņēmāt šo e-pasta ziņojumu, jo esat uzaicināts pievienoties Cherry Byte.',
    ...
    'information' => [
        ...
        'customize'         => 'Pielāgojiet savu Cherry Byte',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Administrators',
            'description'   => 'Viņi iegūst pilnu piekļuvi jūsu Cherry Byte, tostarp klientiem, rēķiniem, pārskatiem, iestatījumiem un lietotnēm.',
        ],
        'manager' => [
            'name'          => 'Vadītājs',
            'description'   => 'Viņi iegūst pilnu piekļuvi jūsu Cherry Byte, taču nevar pārvaldīt lietotājus un lietotnes.',
        ],
        'customer' => [
            'name'          => 'Klients',
