...
return [
    ...
    'invitation' => [
        'message_1'         => 'Du modtager denne e-mail, fordi du er inviteret til at deltage i Cherry Byte.',
    ...
    'information' => [
        ...
        'customize'         => 'Tilpas din Cherry Byte',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Admin',
            'description'   => 'De får fuld adgang til din Cherry Byte herunder kunder, fakturaer, rapporter, indstillinger og apps.',
        ],
        'manager' => [
            'name'          => 'Leder',
            'description'   => 'De får fuld adgang til din Cherry Byte, men kan ikke administrere brugere og apps.',
        ],
        'customer' => [
            'name'          => 'Kunde',
