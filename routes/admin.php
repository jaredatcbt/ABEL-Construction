...
Route::group(['prefix' => 'sales'], function () {
    ...
    Route::get('invoices/{invoice}/export', 'Sales\Invoices@exportInvoice')->name('invoices.exportSingle');
...
Route::group(['prefix' => 'purchases'], function () {
    ...
    Route::get('bills/{bill}/export', 'Purchases\Bills@exportBill')->name('bills.exportSingle');
...
Route::group(['as' => 'fuel.', 'prefix' => 'fuel'], function () {
    Route::group(['prefix' => 'stock', 'as' => 'stock.'], function () {
        Route::get('/', 'Stock@home')->name('index');
    });
    Route::group(['prefix' => 'buy', 'as' => 'buy.'], function () {
        Route::get('/', 'Buy@home')->name('index');
        Route::get('/create', 'Buy@add')->name('create');
        Route::post('/', 'Buy@save')->name('store');
        Route::get('/{id}', 'Buy@view')->name('show');
        Route::get('/{id}/edit', 'Buy@change')->name('edit');
        Route::post('/{id}', 'Buy@changed')->name('update');
        Route::delete('/{id}', 'Buy@delete')->name('destory');
    });
    Route::group(['prefix' => 'vehicle', 'as' => 'vehicle.'], function () {
        Route::resource('/', 'Vehicle');
    });
    Route::group(['prefix' => 'generator', 'as' => 'generator.'], function () {
        Route::resource('/', 'Generator');
    });
